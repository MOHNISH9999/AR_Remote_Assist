...
package com.example.user.arremoteassist.ui;
...
import com.example.user.arremoteassist.R;
...
public class HandPointer {
    ...
    public
    HandPointer ( Context context) {
        m_context = context;
        m_image = new ImageView(m_context);
        m_image.setImageResource( R.drawable.android_icon);
