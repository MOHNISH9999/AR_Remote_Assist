...
import com.example.user.arremoteassist.callbacks.AccessControlCallbackImpl;
import com.example.user.arremoteassist.callbacks.AuthenticationCallbackImpl;
import com.example.user.arremoteassist.callbacks.InputCallbackImpl;
...
class ScreenSharingWrapper {
     ...
     */
    private static final String SDK_TOKEN = "{34062abc-b6cf-718c-329a-b265d957605f}";
    ...
    public static
    ScreenSharingWrapper getInstance () {
        return sInstance;
    }
     ...
     */
    public
    void setRunningStateListener ( RunningStateListener listener ) {
     ...
     */
    public
    void startTeamViewerSession ( Context context , String sessionCode ) {
        ...
        m_teamViewerSdk = new TeamViewerSdk.Builder ( context )
                ...
                .withSessionCallback ( new SessionCallback ( ) {
                    @Override
                    public
                    void onSessionStarted ( TeamViewerSession teamViewerSession ) {
    ...
    Settings createSettings () {
        ...
        settings.accessControlRules.put (
                AccessType.RemoteControl ,
                AccessControlRule.AfterConfirmation );
        return settings;
    }
    ...
    private
    void sessionStarted ( Context context , TeamViewerSession teamViewerSession ) {
        ...
        if ( teamViewerSession instanceof AssistARSession ) {
            ...
            context.startActivity ( AssistARSessionUI.INSTANCE.createIntentForAssistARSessionActivity ( context ,
                    "Shared Files" ) );
        }
